...
# -----------------------------------------------------------------------------
# 1. Equipment Configurations & Parameter Definitions
# -----------------------------------------------------------------------------
EQUIPMENT_CONFIGS = {
...
def generate_pdf_report(equipment_name, meta_data, param_data, notes, logo_bytes, photo_bytes, include_as_found):
    ...
    # Populate Data & Cell Color Styling
    row_idx = 1
...
# Dynamic Measurement Entry Form
with col2:
...
# -----------------------------------------------------------------------------
# 4. On-Screen Summary & PDF Download
# -----------------------------------------------------------------------------
if submitted:
    st.markdown("---")
